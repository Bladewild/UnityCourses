...
public class FlatLitToonInspector : ShaderGUI
{
	...
	MaterialProperty fresnelMultiply;
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] props)
    {
        { //Find Properties
			...
			fresnelMultiply = FindProperty("_FresnelMultiply", props);
        ...
        { //Shader Properties GUI
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                materialEditor.TexturePropertySingleLine(new GUIContent("Shadow Mask", "Specifies areas of shadow influence"), shadowMask);
                materialEditor.ShaderProperty(fresnel, "Fresnel");
				materialEditor.ShaderProperty(fresnelMultiply, "Fresnel Multiply");
