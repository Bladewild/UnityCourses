	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 frag(VertexOutput i) : COLOR
			{
				...
				// It is not used here because it does not seem to fit toon shading. 
				...
				// Shadow appearance settings/hacks
				...
				// Indirect specular should have a sharp edge.
				...
				indirectContribution +=
					...
					* (1-directContribution) * indirectLighting  * reflectionMap * !i.is_outline;
				...
				float3 tertiaryContribution = surfaceReduction * reflectionMap * FresnelLerp (specColor, grazingTerm, nDotV)  * !i.is_outline;

				float3 finalColor = emissive + directContribution + indirectContribution + tertiaryContribution;
